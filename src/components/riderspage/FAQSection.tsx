    ...
    <section className="px-6 py-20 lg:px-20">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mb-16 flex flex-col items-center gap-4 text-center">
          <span className="text-2xl font-medium uppercase tracking-[2.4px] text-primary">
            Common Questions
          </span>
          <h2 className="text-lg font-medium tracking-[-0.025em] text-foreground">
         Everything you need to know about joining the squad.
          </h2>
        </div>
